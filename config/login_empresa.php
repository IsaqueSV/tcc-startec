<?php
	...
	if(isset($_POST['log_email']) AND isset($_POST['log_cnpj']) AND isset($_POST['log_senha'])){
		$email = $_POST['log_email'];
		$cnpj = $_POST['log_cnpj'];
		$senha = $_POST['log_senha'];

		$sql_verifica = "SELECT * FROM tb_usuario WHERE ds_email = '$email' AND ds_cnpj = '$cnpj' AND ds_senha = '$senha'";
